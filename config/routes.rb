Spree::Core::Engine.add_routes do
  ...
  devise_scope :spree_user do
    ...
    get '/confirm' => 'user_confirmations#show',
        as: :confirmation if Spree::Auth::Config[:confirmable]
  end
  ...
  put '/checkout/registration' => 'checkout#update_registration',
      as: :update_checkout_registration
  ...
  namespace :admin, path: Spree.admin_path do
    devise_for :spree_user,
               ...
               controllers: { sessions: 'spree/admin/user_sessions',
                              asswords: 'spree/admin/user_passwords' },
               skip: [:unlocks, :omniauth_callbacks, :registrations],
               path_names: { sign_out: 'logout' },
               path_prefix: :user
    devise_scope :spree_user do
      get '/authorization_failure', to: 'user_sessions#authorization_failure',
                                    as: :unauthorized
      get '/login' => 'user_sessions#new', as: :login
      post '/login' => 'user_sessions#create', as: :create_new_session
      get '/logout' => 'user_sessions#destroy', as: :logout
